						...
						className={cn(
							...
							selected?.id === card.id
								...
								: lastSelected?.id === card.id
									? 'z-40 h-full w-full rounded-xl border border-gray-200 bg-white dark:border-stone-500'
									: 'h-full w-full rounded-xl border border-gray-200 bg-white dark:border-stone-500'
						)}
